...
namespace Experity.SprintDashboard.Data.GenPro.Entities.HelperClasses
{
    ...
    public partial class LinqMetaData : ILinqMetaData
    {
        ...
        /// <summary>returns the datasource to use in a Linq query when targeting ClinicEntity instances in the database.</summary>
        public DataSource2<ClinicEntity> Clinic { get { return new DataSource2<ClinicEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }

        /// <summary>returns the datasource to use in a Linq query when targeting PracticeEntity instances in the database.</summary>
        public DataSource2<PracticeEntity> Practice { get { return new DataSource2<PracticeEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
