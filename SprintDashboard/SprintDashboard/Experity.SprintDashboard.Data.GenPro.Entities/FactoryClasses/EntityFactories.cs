...
namespace Experity.SprintDashboard.Data.GenPro.Entities.FactoryClasses
{
    ...
    {
        private readonly EntityType _typeOfEntity;
        ...
        public EntityFactoryBase2(string entityName, EntityType typeOfEntity, bool isInHierarchy) : base(entityName)
        {
        ...
        /// <inheritdoc/>
        public override IEntity2 CreateEntityFromEntityTypeValue(int entityTypeValue) { return GeneralEntityFactory.Create((EntityType)entityTypeValue); }
    ...
    /// <summary>Factory to create new, empty ClinicEntity objects.</summary>
    [Serializable]
    public partial class ClinicEntityFactory : EntityFactoryBase2<ClinicEntity>
    {
        /// <summary>CTor</summary>
        public ClinicEntityFactory() : base("ClinicEntity", EntityType.ClinicEntity, false) { }
        /// <inheritdoc/>
        protected override IEntity2 CreateImpl(IEntityFields2 fields) { return new ClinicEntity(fields); }
    }

    [Serializable]
    public partial class PracticeEntityFactory : EntityFactoryBase2<PracticeEntity>
    {
        /// <summary>CTor</summary>
        public PracticeEntityFactory() : base("PracticeEntity", EntityType.ClinicEntity, false) { }
        /// <inheritdoc/>
        protected override IEntity2 CreateImpl(IEntityFields2 fields) { return new PracticeEntity(fields); }
    }

    /// <summary>Factory to create new, empty ConversationEntity objects.</summary>
    ...
    public static class EntityFactoryFactory
    {
        ...
        {
            foreach (int entityTypeValue in Enum.GetValues(typeof(EntityType)))
            {
                var factory = GetFactory((EntityType)entityTypeValue);
        ...
        /// <summary>Gets the factory of the entity with the Experity.SprintDashboard.Data.GenPro.EntityType specified</summary>
        /// <param name="typeOfEntity">The type of entity.</param>
        /// <returns>factory to use or null if not found</returns>
        public static IEntityFactory2 GetFactory(EntityType typeOfEntity)
        {
            switch (typeOfEntity)
            {
                case EntityType.ClinicEntity:
                    return new ClinicEntityFactory();
                case EntityType.PracticeEntity:
                    return new PracticeEntityFactory();
                default:
                    return null;
            }
        }
    ...
    {
        /// <summary>Gets the factory of the Entity type with the Experity.SprintDashboard.Data.GenPro.EntityType value passed in</summary>
        ...
        {
            return new DynamicRelation(leftOperand, joinType, (EntityType)Enum.Parse(typeof(EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
        }

        /// <inheritdoc/>
        public override IDynamicRelation CreateDynamicRelation(string leftOperandEntityName, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
        {
            return new DynamicRelation((EntityType)Enum.Parse(typeof(EntityType), leftOperandEntityName, false), joinType, (EntityType)Enum.Parse(typeof(EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
        }

        /// <inheritdoc/>
        public override IDynamicRelation CreateDynamicRelation(IEntityFieldCore leftOperand, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
        {
            return new DynamicRelation(leftOperand, joinType, (EntityType)Enum.Parse(typeof(EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
        }

        /// <inheritdoc/>
        protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue) { return EntityFactoryFactory.GetFactory((EntityType)entityTypeValue); }
